...
**GitHub:** https://github.com/StarChen-Cycler/sece_reconstruct
...
## Berkeley 500 Benchmark Results

Tested on 500 natural images from the Berkeley Segmentation Dataset:

### EMEG Scores (higher = better contrast)
...
| SECE | 0.271 | 0.099 |
| CLAHE | 0.249 | 0.086 |
| Original | 0.159 | 0.064 |

**Conclusion:** SECEDCT achieves the highest contrast enhancement, matching the paper's findings.

### GMSD Scores (lower = less distortion)
